...
## 📊 Resultaten
Er werd een transcriptomics analyse in R uitgevoerd waarbij een DESeq-, GO- en KEGG-analyses werd toegepast. 
...
Er waren 2085 genen significant up-gereguleerd waarvan de meest significante genen SRGN, BCL2A, ADAMDEC1 waren. Er waren 2487 down-gereguleerde genen waarvan de meest significante ANKRD30BL, MT-ND6, SLC9A3R2, ZNF598 waren, zie tabel 1.
...
##  📝 Conclusie
Dit onderzoek analyseerde de invloed van genexpressie in de pathogenese van RA m.b.v transcriptomics. RA is een auto-immuunziekte waarbij het immuunsysteem verstoord is, zoals uit de resultaten bleek. DESeq-analyse toonde verhoogde expressie van pro-inflammatoire genen en verminderde expressie van genen die balans reguleren in RA-patiënten. In het synoviale weefsel waren DC’s met MHC-klasse 2 verhoogd, wat leidt tot presentatie van lichaamseigen antigenen aan zelfreactieve Th1-cellen. Deze stimuleren pro-inflammatoire cytokines (zoals IL-1β, IL-6) die synoviumontsteking veroorzaken. 
Overactieve synoviale fibroblasten stimuleren osteoclasten, wat botafbraak bevordert. Sterk up-gereguleerde chemokines CXCL en CCL veroorzaken zo systemische ontstekingen. Veranderingen in VEGF-pathway bleken angiogenese te remmen. Daarnaast was TGF-β sterk verlaagd waarmee pro-inflammatoire Th17-cellen differentiatie werd geremd. Remming van angiogenese en verlaging van TGF-β zijn atypisch voor RA. 

Bij RA waren pro-inflammatoire genen, cytokines en cellen verhoogd, wat chronische synoviumontsteking en gewrichts- en botafbraak veroorzaakt. Hiermee kan geconcludeerd worden dat genexpressie een belangrijke rol speelt in de pathogenese van RA wat mogelijkheden voor gerichte therapieën bied. Vroege immuunreactiegenen bleken verhoogd. 

Verder onderzoek naar interacties tussen DC’s en zelfreactieve Th1-cellen kan bijdragen aan preventie en behandeling
